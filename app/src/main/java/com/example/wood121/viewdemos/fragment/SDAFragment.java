...
public class SDAFragment extends BaseFragment {

    private static final String SDA_FRAGMENT = "SDAFragment";
    private String msg;

    public SDAFragment() {
    }

    public static SDAFragment newInstance() {
        return new SDAFragment();
    }
    ...
    public static APIViewFragment newInstance(String msg) {
        ...
        bundle.putSerializable(SDA_FRAGMENT, msg);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (null != getArguments()) {
            msg = (String) getArguments().getSerializable(SDA_FRAGMENT);
        }
    }
