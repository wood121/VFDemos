 ...
 * @date: 2019/6/12
 * @version:
 * @des: 一般get|post,postJson,file|listfile|mapfile; getBitmap, downloadFile
 */
public class UrlHttpUtil {
    ...
    public static void get(String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBack callBack) {
        new Request(METHOD_GET, url, paramsMap, headerMap, callBack).execute();
    }
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public static void post(String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBack callBack) {
        new Request(METHOD_POST, url, paramsMap, headerMap, callBack).execute();
    }
    ...
    public static void postJson(String url, String jsonStr, Map<String, String> headerMap, CallBack callBack) {
        new Request(url, jsonStr, headerMap, callBack).execute();
    }
    ...
    public static void uploadFile(String url, File file, String fileKey, String fileType, Map<String, String> paramsMap, Map<String, String> headerMap, CallBack callBack) {
        new Request(url, file, null, null, fileKey, fileType, paramsMap, headerMap, callBack).execute();
    }
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public static void uploadListFile(String url, List<File> fileList, String fileKey, String fileType, Map<String, String> paramsMap, CallBack callBack) {
     ...
     * @param callBack：回调接口，onFailure方法在请求失败时调用，onResponse方法在请求成功后调用，这两个方法都执行在UI线程。
     */
    public static void uploadListFile(String url, List<File> fileList, String fileKey, String fileType, Map<String, String> paramsMap, Map<String, String> headerMap, CallBack callBack) {
        new Request(url, null, fileList, null, fileKey, fileType, paramsMap, headerMap, callBack).execute();
    }
    ...
    public static void uploadMapFile(String url, Map<String, File> fileMap, String fileType, Map<String, String> paramsMap, Map<String, String> headerMap, CallBack callBack) {
        new Request(url, null, null, fileMap, null, fileType, paramsMap, headerMap, callBack).execute();
    }
     ...
     * 加载图片
     */
    public static void getBitmap(String url, CallBack.CallBackBitmap callBack) {
     ...
     * 加载图片，带参数
     */
    public static void getBitmap(String url, Map<String, String> paramsMap, CallBack.CallBackBitmap callBack) {
        get(url, paramsMap, null, callBack);
    }
     ...
     * 下载文件,不带参数
     */
    public static void downloadFile(String url, CallBack.CallBackFile callBack) {
     ...
     * 下载文件,带参数
     */
    public static void downloadFile(String url, Map<String, String> paramsMap, CallBack.CallBackFile callBack) {
     ...
     * 下载文件,带参数,带请求头
     */
    public static void downloadFile(String url, Map<String, String> paramsMap, Map<String, String> headerMap, CallBack.CallBackFile callBack) {
