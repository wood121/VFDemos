package com.example.wood121.viewdemos.views.utils;
...
public class SofeKeyBroadManager implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public SofeKeyBroadManager(View activityRootView) {
        this(activityRootView, false);
    }

    public SofeKeyBroadManager(View activityRootView, boolean isSoftKeyboardOpened) {
        mContext = activityRootView.getContext();
    ...
    public void onGlobalLayout() {
        ...
        Log.e("SoftKeyboardStateHelper", "heightDiff:" + heightDiff);
