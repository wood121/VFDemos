...
public class TopBar extends RelativeLayout {
    ...
    public TopBar(Context context, AttributeSet attrs) {
        ...
        Button btn_left = (Button) topBar.findViewById(R.id.btn_left);
        Button btn_right = (Button) topBar.findViewById(R.id.btn_right);
        TextView tv_title = (TextView) topBar.findViewById(R.id.tv_title);
        ...
        int titleBackgroudColor = ta.getResourceId(R.styleable.TopBar_title_backgroud_color, Color.BLUE);
        topBar.setBackgroundColor(titleBackgroudColor);
//        topBar.setBackgroundResource(titleBackgroudColor);
